function [dball, res] = main(varargin)
    ...
    for rr = 1:numel(recLocUni)
        ...
        % plts.CorrelationStability(sigCorrStruct,dur,[db.days]); 

        % Plot matched neurons across some days
        % [pairAcrossAll_fewDays,sigCorr,noiseCorr] = plts.matchedNeuronsAcrossDays(1:5, BestMatch, BestCorr, BestDist, ...
