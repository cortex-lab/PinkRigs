...
def cv_split(ev,**splitkwargs):
    ...
    _,ev['groupID'],counts = np.unique(ev[['visDiff','audDiff','response_direction_fixed']],axis=0,return_inverse=True,return_counts=True)
    ...
    _,(train_idx,_) = sss.split(ev['rt_laserThresh'],ev[['response_direction_fixed','groupID']])
    ev['trainSet'] = False
