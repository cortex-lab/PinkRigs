...
%% Default organization of data for plt.spk.CellRaster active and passive
%
% Parameters: 
% ---------------
% dataTbl (table)
%   This is a table generated by plt.spk.cellRasterAuto using csv.queryExp
...
% ---------------
% data4Gui: struct
%   Structured data for the plt.spk.CellRaster gui includes:
