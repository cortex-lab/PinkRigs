...
% 
RID.mname='AV028'; % mouse name 
RID.date='2022-10-26'; % date
RID.SparseNoise_expnum=6; % expnum related to sparseNoise experiment
RID.root=sprintf('\\\\zaru.cortexlab.net\\Subjects\\%s\\%s',RID.mname,RID.date); % where to find block and timeline for sparsenoise 
RID.ephys_name=sprintf('%s_%s_SparseNoise_part5_g0',RID.mname,RID.date); % ephys recording name
