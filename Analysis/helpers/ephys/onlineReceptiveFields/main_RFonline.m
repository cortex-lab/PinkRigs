...
% 
RID.mname='AV024'; % mouse name 
RID.date='2022-10-11'; % date
RID.SparseNoise_expnum=8; % expnum related to sparseNoise experiment
RID.root=sprintf('\\\\zaru.cortexlab.net\\Subjects\\%s\\%s',RID.mname,RID.date); % where to find block and timeline for sparsenoise 
RID.ephys_name=sprintf('%s_%s_SparseNoise_Part6_g0',RID.mname,RID.date); % ephys recording name
...
RID.Githubfolder = 'C:\Users\Flora\Documents\Github';
