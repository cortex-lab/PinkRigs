...
function [spikeTimes, spikeAmps, spikeDepths,spikeXpos, spikeSites] = ksDriftmap(ksDir, localizedSpikesOnly)
...
spikeFeatXcoords = xcoords(spikeFeatInd+1); 
...
[spikeAmps, ~, templateYpos,~,~, tempAmps, tempsUnW] = ...
  templatePositionsAmplitudes(temps, winv, xcoords,ycoords, spikeTemps, tempScalingAmps);
