...
function [spikeAmps, spikeDepths, templateDepths,spikeXpos,templateXpos,tempAmps, tempsUnW, templateDuration, waveforms] = templatePositionsAmplitudes(temps, winv, xcoords, ycoords, spikeTemplates, tempScalingAmps)
...
%%%% by FLORA %%%
% compute xcoordinate the same way % 
