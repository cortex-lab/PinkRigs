function [ichanidx,sortedRowID]=create_channelmapMultishank(binname,path,savemap)

% binname leads to ap bin file, path is the relevant folder 
% redundant, I know, but this is how Bill Karsh has wrote the readMeta
