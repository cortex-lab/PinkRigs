...
%% Default organization of data for plts.spk.CellRaster active and passive
%
% Parameters: 
% ---------------
% dataTbl (table)
%   This is a table generated by plts.spk.cellRasterAuto using csv.queryExp
%   and csv.loadData. In contains all the sessions to be included in the
%   cell raster, and all the spike data for those sessions
%
% Returns: 
% ---------------
% data4Gui: struct
%   Structured data for the plts.spk.CellRaster gui includes:
%   .evTimes: 3 sets of event times--vis, aud, and movement
%   .evNames: names for the sets of event times
%   .triGrps: grouping sets for each event times (e.g. stim pos or choice)
%   .grpNames: the names for each grouping set
%   .sortTemplates: 'sig' (will sort clusters by significance)
%   .sortTrials: Given an empty to use default
%   .trialTickTimes: Given an empty to use default
